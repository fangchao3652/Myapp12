...
public class PushService extends Service
{
	...
	private static final String		MQTT_HOST = "192.168.0.183";
	...
	private com.example.fc.activity.ConnectionLog mLog;
	...
	public void onCreate() {
       ...
       Log.e("fc","oncreate");
		...
		try {
			mLog = new com.example.fc.activity.ConnectionLog();
	...
	/*	Notification n = new Notification();
		...
		n.setLatestEventInfo(this, NOTIF_TITLE, json, pi);

		mNotifMan.notify(NOTIF_CONNECTED, n);
		Log.e("fc", json);*/
		com.example.fc.activity.MqttNotifier.notify(this, json);
	...
	private class MQTTConnection implements MqttSimpleCallback {
		...
		public MQTTConnection(String brokerHostName, String initTopic) throws MqttException {
	      ...
	      String clientID = MQTT_CLIENT_ID + "/" + mPrefs.getString(PREF_DEVICE_ID, "");
	        	  //	String clientID = MQTT_CLIENT_ID + "/123" ;
				...
				initTopic = MQTT_CLIENT_ID+"Fang" ;
				subscribeToTopic(initTopic);
		
				log("Connection established to " + brokerHostName + " on topic " + initTopic);
            Log.e("fc","Connection established to " + brokerHostName + " on topic " + initTopic);
				// Save start time
				mStartTime = System.currentTimeMillis();
