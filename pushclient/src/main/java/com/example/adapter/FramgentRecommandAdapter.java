 ...
 */
public class FramgentRecommandAdapter extends FooterAdapter {
    //是否是大图模式
    ...
    public FramgentRecommandAdapter(BaseBean data, Activity mContext) {
        this.data = data;
...
/*
            ViewGroup.LayoutParams mParams = vh.itemView.getLayoutParams();
            mParams.height = CommonUtils.dipToPixels(280);

            vh.itemView.setLayoutParams(mParams);*/
          ...
          /*  ViewGroup.LayoutParams mParams = vh.itemView.getLayoutParams();
            mParams.height = CommonUtils.getScreenWidthPX(mContext) * 2 / 6;
