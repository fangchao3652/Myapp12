...
public class PagerSlidingTab extends HorizontalScrollView {
    ...
    public PagerSlidingTab(Context context, AttributeSet attrs, int defStyle) {
        ...
        tabTextColor = a.getColor(R.styleable.PagerSlidingTab_pstsTextColor, tabTextColor);
        tabTextSelectedColor = a.getColor(R.styleable.PagerSlidingTab_pstsTextColor, tabTextSelectedColor);
...
//            updateTabStyles();
    ...
    public void setTTextSelectedColorRecource(int resId) {
