...
public class DimensionCalculator {
  ...
  /**
   * Returns {@link android.graphics.Rect} representing margins for any view.
   *
  ...
  /**
   * Converts {@link android.view.ViewGroup.MarginLayoutParams} into a representative {@link android.graphics.Rect}
   *
   * @param marginLayoutParams margins to convert to a Rect
   * @return Rect representing margins, where {@link android.view.ViewGroup.MarginLayoutParams#leftMargin} is equivalent to
   * {@link android.graphics.Rect#left}, etc.
   */
