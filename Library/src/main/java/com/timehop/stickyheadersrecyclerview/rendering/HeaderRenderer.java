...
public class HeaderRenderer {
   ...
   *                     the {@link android.graphics.Rect#left} and {@link android.graphics.Rect#top} properties, respectively.
   */
   ...
   * @return a {@link android.graphics.Rect} for clipping a provided header to the padding of a recycler view
   */
