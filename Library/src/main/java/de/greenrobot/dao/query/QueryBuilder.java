...
public class QueryBuilder<T> {
    ...
    /**
     * Shorthand for {@link de.greenrobot.dao.query.QueryBuilder#build() build()}.{@link de.greenrobot.dao.query.Query#list() list()}; see {@link de.greenrobot.dao.query.Query#list()} for
     * details. To execute a query more than once, you should build the query and keep the {@link de.greenrobot.dao.query.Query} object for
     * efficiency reasons.
     */
    public List<T> list() {
        return build().list();
    ...
    /**
     * Shorthand for {@link de.greenrobot.dao.query.QueryBuilder#build() build()}.{@link de.greenrobot.dao.query.Query#listLazy() listLazy()}; see
     * {@link de.greenrobot.dao.query.Query#listLazy()} for details. To execute a query more than once, you should build the query and keep the
     * {@link de.greenrobot.dao.query.Query} object for efficiency reasons.
     */
    ...
    /**
     * Shorthand for {@link de.greenrobot.dao.query.QueryBuilder#build() build()}.{@link de.greenrobot.dao.query.Query#listLazyUncached() listLazyUncached()}; see
     * {@link de.greenrobot.dao.query.Query#listLazyUncached()} for details. To execute a query more than once, you should build the query and
     * keep the {@link de.greenrobot.dao.query.Query} object for efficiency reasons.
     */
    ...
    /**
     * Shorthand for {@link de.greenrobot.dao.query.QueryBuilder#build() build()}.{@link de.greenrobot.dao.query.Query#listIterator() listIterator()}; see
     * {@link de.greenrobot.dao.query.Query#listIterator()} for details. To execute a query more than once, you should build the query and keep
     * the {@link de.greenrobot.dao.query.Query} object for efficiency reasons.
     */
    ...
    /**
     * Shorthand for {@link de.greenrobot.dao.query.QueryBuilder#build() build()}.{@link de.greenrobot.dao.query.Query#unique() unique()}; see {@link de.greenrobot.dao.query.Query#unique()}
     * for details. To execute a query more than once, you should build the query and keep the {@link de.greenrobot.dao.query.Query} object for
     * efficiency reasons.
     */
    public T unique() {
        return build().unique();
    ...
    /**
     * Shorthand for {@link de.greenrobot.dao.query.QueryBuilder#build() build()}.{@link de.greenrobot.dao.query.Query#uniqueOrThrow() uniqueOrThrow()}; see
     * {@link de.greenrobot.dao.query.Query#uniqueOrThrow()} for details. To execute a query more than once, you should build the query and keep
     * the {@link de.greenrobot.dao.query.Query} object for efficiency reasons.
     */
    ...
    /**
     * Shorthand for {@link de.greenrobot.dao.query.QueryBuilder#buildCount() buildCount()}.{@link de.greenrobot.dao.query.CountQuery#count() count()}; see
     * {@link de.greenrobot.dao.query.CountQuery#count()} for details. To execute a query more than once, you should build the query and keep
     * the {@link de.greenrobot.dao.query.CountQuery} object for efficiency reasons.
     */
    public long count() {
